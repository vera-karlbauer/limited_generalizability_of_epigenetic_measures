...
- Combine lineplots for each epigenetic clock with/without celltype correction into one plot (extened data Figure 1).
...
### Combine all line plots and export (= extended data figure 1)

```{r}
## arrange & export all plots
png(filename = "./04_figures/extended_figure_1_combined_lineplot_all_clocks.png", 
