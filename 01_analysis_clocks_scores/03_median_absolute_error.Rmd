---
title: 'Evaluating epigenetic clocks and scores: median absolute error'
...
# Purpose:
- Calculate and plot median absolute error (MAE) per clock per tissue (Figure 1)
...
maeplot <- ggplot(mae_clocks, aes(x = clock_name, y = mae, fill = tissue)) +
  ...
  scale_fill_brewer(palette = "Set1", name = "Tissue", breaks = c("blood", "saliva")) +
...
maeplot
ggsave(filename = "figure_1_mae_per_clock.png", path = "./04_figures", device = 'png', height = 7, width = 10, dpi = 700)
```
