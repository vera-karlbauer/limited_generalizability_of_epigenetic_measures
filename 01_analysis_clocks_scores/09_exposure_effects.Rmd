...
- Plot results as barplot (Figure 6).
...
# Plot ELA and SES effects (Figure 6)
...
png(file = "04_figures/figure_6_combined_barplot_exposures.png", height = 7, width = 10, units = 'in', res = 700)
results_barplot
dev.off()
```
