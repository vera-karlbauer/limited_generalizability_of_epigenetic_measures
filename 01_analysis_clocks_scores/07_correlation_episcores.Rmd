...
- Plot results as corrplots (right side of Figure 4).
...
### Create combined correlation plot (Figure 4B)

```{r}
# initialize graphics device
tiff(file = "04_figures/figure_4b_corrplot_all_episcores_cross_tissue.png", height = 6.7, width = 5, units = 'in', res = 700)
par(mfrow=c(1,2),
    mar = c(1,1,1,1),
    oma = c(0,0,4,0))
