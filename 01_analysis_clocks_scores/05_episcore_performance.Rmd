...
- Combine lineplots for each epigenetic score with/without celltype correction into one plot (extended data Figure 2).
...
png(filename = "./04_figures/extended_figure_2_combined_lineplot_all_scores.png", 
