---
title: "Evaluating epigenetic clocks and scores: epigenetic clock cross-tissue correlations"
...
- Calculate correlations separately for unadjusted and celltype-adjusted clocks.
...
- Plot results as corrplots (Figure 4A-B).
- Export results as Supplementary Table 4.
...
### Step 3: Subset data (T0 only, clocks only, with vs. without cell type adjustment)
...
## Calculate correlations with and without cell type adjustment
...
## Aggregate data without cell type adjustment
...
## Aggregate data with cell type adjustment
...
## Create combined correlation plot (Figure 4A & 4B)

```{r}
### create combined corrplot
# initialize graphics device
tiff(file = "04_figures/figure_4ab_corrplot_all_epiage_measures_cross_tissue.png", height = 6.7, width = 5, units = 'in', res = 700)
par(mfrow=c(1,2),
    mar = c(1,1,0,0),
    oma = c(0,0,3,0))
...
corrplot(corr = corrmat_nocell,
         ...
         na.label = "NA",
         mar = c(0,0.2,0,1))
mtext("A", side = 3, line = 1, at = -2.2, cex = 1.2, font = 2)
mtext("Clocks (unadjusted)", side = 3, line = 1, at = 1, cex = 1, font = 2)
...
corrplot(corr = corrmat_cell,
         ...
         na.label = "NA", 
         mar = c(0,0.2,0,1))
mtext("B", side = 3, line = 1, at = -2.4, cex = 1.2, font = 2)
mtext("Clocks (cell type adjusted)", side = 3, line = 1, at = 1, cex = 1, font = 2)
...
```{r}
# initialize graphics device
tiff(file = "04_figures/figure_4e_corrplot_cross_tissue_colorscale.png", height = 7, width = 10, units = 'in', res = 700)
...
## Export results (Supplementary Table 4)

```{r}
# export
write_xlsx(correlations_epiclocks, path = "./05_tables_for_publication/supptable_4_results_correlations_epiclocks.xlsx", col_names = TRUE, format_headers = TRUE)
```
