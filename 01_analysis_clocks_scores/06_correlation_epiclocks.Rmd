...
- Plot results as corrplots (left side of Figure 4).
...
## Create combined correlation plot (Figure 4A)

```{r}
### create combined corrplot
# initialize graphics device
tiff(file = "04_figures/figure_4a_corrplot_all_epiage_measures_cross_tissue.png", height = 6.7, width = 5, units = 'in', res = 700)
par(mfrow=c(1,2),
    mar = c(1,1,1,1),
    oma = c(0,0,4,0))
...
```{r}
# initialize graphics device
tiff(file = "04_figures/figure_4c_corrplot_cross_tissue_colorscale.png", height = 7, width = 10, units = 'in', res = 700)
